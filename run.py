...
parser.add_argument('-ait', '--iterations_autoencoder',     type=int,   default=100,            help='number of iterations to run the autoencoder')
parser.add_argument('-cit', '--iterations_classifier',      type=int,   default=100,            help='number of iterations to run the classifier')
...
if __name__ == '__main__':
	...
	FLAGS.load_dir = '/Users/frank/stanford/spring2017/slp/project/code/saved_models/rnn_inherited/autoencoder_and_classifier/2017-06-03 21:59:30.890055,0,rnn_inherited'
	FLAGS.indices = [0]
